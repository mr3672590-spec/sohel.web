function Services() {
  ...
  return (
    <div className="min-h-screen text-black dark:text-white px-6 md:px-20 py-12 transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {services.map((item, index) => (
          <div key={index} className="relative group">
            ...
            {/* Card */}
            <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 group-hover:border-cyan-400 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
